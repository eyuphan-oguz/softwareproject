...
class _LoginPageViewState extends State<LoginPageView> {
    ...
    if (res == "success") {
      ...
      if(_emailController.text == "admin@gmail.com"){
        ...
        Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) =>  RouterPageView()
        ),
      );
      }
    } else {
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              !_isLoading ? ButtonWidget(onPressed: signInUser, buttonText: "Oturum Aç", size: size/1, backgroundColor: Colors.transparent,):
        ...
        MaterialPageRoute(
          builder: (context) =>  RegisterPageView()
              ...
              }, buttonText: "Hesap Oluştur", size: size/1, backgroundColor: Colors.transparent,),
              SizedBox(height: size.height*0.04,),
              Padding(
